...
FROM PUB_p_subscription, PUB_p_partner, PUB_p_partner AS RecipientPartner, PUB_a_gift_batch, PUB_a_gift, PUB_a_gift_detail
--, PUB_m_extract_master, PUB_m_extract
